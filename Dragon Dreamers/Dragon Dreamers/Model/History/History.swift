...
class History {
    ...
    var chapters = [Chapter(speechs: [Speech(text: "Tutorial placeholder 1"),
                                      Speech(text: "Tutorial placeholder 2", decisionText: ["Tutorial placeholder 2","Tutorial placeholder 2","Tutorial placeholder 2","Tutorial placeholder 2","Tutorial placeholder 2"])]),
                    Chapter(speechs: [Speech(text: "As conversas com a minha vó me fizeram perceber melhor as maneiras como eu interagi com o mundo"),
                                      ...
                                      Speech(text: "Entre as outras crianças...", decisionText: ["Eu fui o mais tranquilo da turma, consegui ter vários amigos e todos gostavam de mim","Eu fiz poucos amigos, mas fiquei muito próximo deles. Eu os defendia, eles me defendiam.","Eu era a criança responsável, alguns me admiravam por isso, alguns se irritavam com isso, mas todos prestavam atenção quando eu falava","Eu era o líder da galera, e todos sabiam disso. Todos me seguiam, e ninguém me enfrentava.","5"]),
