...
class History {
    ...
    var chapters = [Chapter(speechs: [Speech(text: "Uma das pessoas mais importantes na minha vida foi a minha avó"),
                                      Speech(text: "Enquanto meu pai e minha mãe trabalhavam, ela ficava em casa comigo, cuidando de mim"),
                                      Speech(text: "Uma das primeiras coisas que eu me lembro foi um dos ensinamentos que ela me deu"),
                                      Speech(text: "É uma história que foi passada para ela pela minha tataravó..."),
                                      Speech(text: "... e que eu devo passar para os meus netos"),
                                      
                                      Speech(enemySpeech: "Oi, minha criança. Quer que eu conte a história dos Caminhos? (Ver tutorial)", decisionText: ["Quero sim, vó!","","Não precisa me falar não, vó. A mãe já me contou (Pular tutorial)","",""]),
                                      
                                      Speech(enemySpeech: "Há muitos anos, nossa família passa adiante a história que chamamos de Os Quatro Caminhos"),
                                      Speech(enemySpeech: "Todos os caminhos apresentam maneiras diferentes de interagir com as pessoas ao seu redor"),
                                      Speech(enemySpeech: "É preciso ter equilíbrio ao trilhar todos os caminhos, pois todos podem te ajudar, mas podem te prejudicar também"),
                                      Speech(enemySpeech: "Existem quatro Caminhos, o Caminho do Oceano, o Caminho da Areia, o Caminho da Brisa e o Caminho do Sol"),
                                      Speech(enemySpeech: "O Caminho do Oceano é o caminho da empatia, da compreensão, de se por no lugar do outro"),
                                      Speech(enemySpeech: "Pense nas pessoas se banhando na água vinda do oceano nas praias"),
                                      Speech(enemySpeech: "A água dos oceanos refresca, acalma, diverte. Da mesma maneira é o Caminho do Oceano"),
                                      Speech(enemySpeech: "Mas é preciso ficar atento ao trilhar o Caminho do Oceano"),
                                      Speech(enemySpeech: "Quem busca agradar aos outros o tempo todo corre o risco de nunca se preocupar consigo mesmo"),
                                      Speech(enemySpeech: "O Caminho da Areia é o caminho da autoproteção, do bloqueio, da adaptação, e do preparo"),
                                      Speech(enemySpeech: "Pense na areia da praia"),
                                      Speech(enemySpeech: "Como ela se adapta quando pisamos nela, deixando pegadas, como crianças usam ela para construir castelos e como ela muda ao ficar seca ou molhada, quente ou fria"),
                                      Speech(enemySpeech: "O Caminho da Areia é semelhante. Com ele adaptamos para evitar impactos, mudamos para evitar conflitos, construímos castelos ao nosso redor para nos protegermos"),
                                      Speech(enemySpeech: "É preciso se cuidar ao trilhar o Caminho da Areia"),
                                      Speech(enemySpeech: "Quem se defende demais e se protege demais corre o risco de ignorar as pessoas ao redor, e de ser áspero e rude com aqueles com quem conversa"),
                                      Speech(enemySpeech: "O Caminho da Brisa é o caminho que muda, questiona e guia. Traz tanto dúvidas quanto respostas"),
                                      Speech(enemySpeech: "Imagine esse caminho como a Brisa na praia. Ela ventila as coisas, esfriando o calor da tarde"),
                                      Speech(enemySpeech: "Ela também bagunça os guarda-sóis na praia, levanta a areia, muda as coisas por onde passa. Além disso, é a brisa que movimenta as velas dos barcos"),
                                      Speech(enemySpeech: "O Caminho da Brisa funciona dessa maneira. Questionamos as outras pessoas, enxergamos brechas em suas opiniões e crenças, e propomos mudanças e respostas"),
                                      Speech(enemySpeech: "Mas o Caminho da Brisa também traz seus problemas"),
                                      Speech(enemySpeech: "Pessoas que muito questionam correm o risco de parecerem frias, distantes ou arrogantes, podem causar mais confusão do que ajuda"),
                                      Speech(enemySpeech: "O Caminho do Sol é o caminho do ataque, da crítica, direto e seco. É o caminho que queima, que muda, que esquenta"),
                                      Speech(enemySpeech: "Veja o Sol. Ele nos aquece e nos ilumina, mas aqueles que não se protegem dele podem sofrer"),
                                      Speech(enemySpeech: "Ele queima nossa pele e machuca os nossos olhos"),
                                      Speech(enemySpeech: "O Caminho do Sol pode aquecer e iluminar aqueles que o trilham, permitindo alcançar o que eles desejam, e a mudar o que incomoda"),
                                      Speech(enemySpeech: "Mas se seguido de maneira descuidada, pode machucar as pessoas ao redor, e te tornar uma pessoa agressiva e rude")]),
