...
class History {
    ...
    var chapters = [Chapter(speechs: [Speech(text: "Tutorial placeholder 1"),
                    ...
                    Chapter(speechs: [Speech(text: "3balão1"),
                                      Speech(text: "3balão2", decisionText: ["1","2","3","4","5"], posDecisionText: ["","","",""])]),
                    Chapter(speechs: [Speech(text: "4balão1"),
                                      Speech(text: "4balão2", decisionText: ["1","2","3","4","5"], posDecisionText: ["","","",""])])]
